...
@javax.annotation.Generated(
    ...
    comments = "Source: src/main/java/model/proto/search_cluster_protos.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class SearchServiceGrpc {

  private SearchServiceGrpc() {}

  public static final String SERVICE_NAME = "distributed.search.SearchService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<model.proto.SearchModel.Request,
      model.proto.SearchModel.Response> getSearchMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Search",
      requestType = model.proto.SearchModel.Request.class,
      responseType = model.proto.SearchModel.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<model.proto.SearchModel.Request,
      model.proto.SearchModel.Response> getSearchMethod() {
    io.grpc.MethodDescriptor<model.proto.SearchModel.Request, model.proto.SearchModel.Response> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<model.proto.SearchModel.Request, model.proto.SearchModel.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  model.proto.SearchModel.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  model.proto.SearchModel.Response.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void search(model.proto.SearchModel.Request request,
        io.grpc.stub.StreamObserver<model.proto.SearchModel.Response> responseObserver) {
  ...
  public static final class SearchServiceStub
    ...
    /**
     */
    public void search(model.proto.SearchModel.Request request,
        io.grpc.stub.StreamObserver<model.proto.SearchModel.Response> responseObserver) {
  ...
  public static final class SearchServiceBlockingStub
    ...
    /**
     */
    public model.proto.SearchModel.Response search(model.proto.SearchModel.Request request) {
  ...
  public static final class SearchServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<model.proto.SearchModel.Response> search(
        model.proto.SearchModel.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((model.proto.SearchModel.Request) request,
              (io.grpc.stub.StreamObserver<model.proto.SearchModel.Response>) responseObserver);
          break;
        default:
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              model.proto.SearchModel.Response>(
  ...
  private static abstract class SearchServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return model.proto.SearchModel.getDescriptor();
    }
